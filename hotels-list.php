<?php
    ...
    echo '<h1 class="list-header">Hotels</h1>';
    echo '<table>';
    echo '<thead>';
    echo '<tr>';
    echo '<td>ID</td>';
    ...
    while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
        $hotelID = $row['hotelID'];
        echo '<tr><td>' . $row['hotelID'] . '</td>' . '<td>' . $row['hotelName'] . '</td>' . '<td>' . $row['hotelAddress'] . '</td>' . '<td>' . $row['city'] . '</td>' . '<td>' . $row['postcode'] . '</td>' . '<td>' . $row['hotelTelNo'] . '</td> <td><a href="updatef-hotel.php?hotelID='.$hotelID.'"><span class="material-symbols-rounded">edit</span></a></td> <td><a href="hotels-delete.php?hotelID='.$hotelID.'"><span class="material-symbols-rounded">delete</span></a></td> </tr>';
    }
    echo '</tbody>';
    echo '</table>';
